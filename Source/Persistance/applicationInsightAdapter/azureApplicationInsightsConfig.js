  ...
  static init(
    paramaters = {
      ...
      APPINSIGHTS_CONNECTIONSTRING:
        "InstrumentationKey=6e9e22a4-b595-4e06-bab3-235523819afc;IngestionEndpoint=https://westus2-2.in.applicationinsights.azure.com/",
    }
  ) {
    try {
      const defaultValues = {};
      ...
      appInsights
        .setup(paramaters.APPINSIGHTS_CONNECTIONSTRING)
